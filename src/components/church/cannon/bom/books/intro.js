  ...
  render () {
    return (
      ...
      <h3>Keystone:</h3>
        ...
        precepts, than by any other book”</p>
        <p>To understand this statement, we need to ask:</p>
        <li>1)What is meant by "our religion"?</li>
        ...
        <h4>Our Religion</h4>
          ...
          Truth is "Mormonism."</p>
          <p>We see the fundamental principles that make up the religion as the
          mission and success of Christ.  This extends into all truth.  Brigham
          Young had a lot to say on this. This leads us to ask what is truth in
          the same way Pilot asked Christ thaat same question(John 18:37-38).
          Here we refer to a few scriptures:</p>
          <p>D&C 84:45-47</p>
          <p>For the word of the Lord is truth, and whatsoever is truth is light,
          and whatsoever is light is Spirit, even the Spirit of Jesus Christ.  And
          the Spirit giveth light to every man that cometh into the world; and the
          Spirit enlighteneth every man through the world, that hearkeneth to the
          voice of the Spirit.  And every one that hearkeneth to the voice of the
          Spirit cometh unto God, even the Father.  And the Father teacheth him
          of the covenant which he has renewed and confirmed upon you, which is
          confirmed upon you for your sakes, and not for your sakes only, but for
          the sake of the whole world.</p>
          <p>D&C 93:24,30,36</p>
          <p>And truth is knowledge of things as they are, and as they were, and
          as they are to come;...All truth is independent in that sphere in which
          God has placed it, to act for itself, as all intelligence also;
          otherwise there is no existence...The glory of God is intelligence, or,
          in other words, light and truth.</p>
          <p>John 17:17-19</p>
          <p>Sanctify them through thy truth: thy word is truth.  As thou hast sent
          me into the world, even so have I also sent them into the world. And for
          ...
          witness, because the Spirit is truth.</p>
          <p>D&C 88:66-68</p>
          <p>Behold, that which you hear is as the voice of one crying in the
          wilderness—in the wilderness, because you cannot see him—my voice,
          because my voice is Spirit; my Spirit is truth; truth bideth and hath no
          end; and if it be in you it shall abound. And if your eye be single to
          my glory, your whole bodies shall be filled with light, and there shall
          be no darkness in you; and that body which is filled with light
          comprehendeth all things. Therefore, sanctify yourselves that your minds
          ...
          in his own way, and according to his own will.</p>
          <p>The equivalences drawn here are as follows:</p>
          <li>1) The word of the Lord is either the same or a sub-category of
          Truth</li>
        ...
        <h4>The Relationship</h4>
          ...
          to be true, then the claims of Joseph's status as a prophet and
          reality of the priesthood authority will be able to bear scrutiny.
