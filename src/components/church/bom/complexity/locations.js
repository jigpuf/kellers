...
import OldWorld from './locations/oldWorld.js'
import NewWorld from './locations/newWorld.js'
...
pickTier2 = (item) => {
  ...
  render () {
    const Items = [
        {name: 'Old World', slug: 'oldWorld', component:<OldWorld />},
        {name: 'New World', slug: 'newWorld', component:<NewWorld />},
      ]
