...
class Covenant extends React.Component {
  render () {
    return (
      <div>
      ...
      Key Words: Covenant, Zion, promise, Promise Land, Temple, ordinanes,
      ...
      the Firstborn, pure in Heart, One Heart and One Mind<br/>
      Sources:
      </div>
    );
  }
