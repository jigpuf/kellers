...
const WeightLoss = () => {
  const items = [
      ...
      {day: 8, date:'Feb 16', wt:294.8, bmi:39.9, bf:38.9, wtr:44.9, mus:42.0, ff:180.1, sf:25.0, vf:20.0, mm:168.6, bone:9.5, diet:'keto 8hr' },
      {day: 9, date:'Feb 17', wt:0, bmi:0, bf:0, wtr:0, mus:0, ff:0, sf:0, vf:0, mm:0, bone:0, diet:'keto' },
      {day: 10, date:'Feb 18', wt:0, bmi:0, bf:0, wtr:0, mus:0, ff:0, sf:0, vf:0, mm:0, bone:0, diet:'keto' },
