...
/*  <div>
    <div id="videosTier1">
      ...
      <button class="tier1">Funny</button>
      <button class="tier1">How to</button>
    ...
    <div>
      ...
      <h3>Favorite Music</h3>
        <ul>
          ...
          <li>Blue October</li>
            <ul>
              <li>Come on Closer</li>
              <li>X amount of Words</li>
            </ul>
          <li>Bob Marley:</li>
            <ul>
              <li>Exodous</li>
    ...
    <h3>Church</h3>
      <ul>
        ...
        <li>Astro-Theology</li>
        <li>Book of Mormon Geography:</li>
        <li>Chapter Lectures:</li>
          <ul>
        ...
        <li>Extra-cononical texts:</li>
        <li>Historical Church Documents:</li>
        <li>Polygamy:</li>
        <li>Pre-mortal Existance:</li>
        <li>Prophecy:</li>
        <li>Sacred Geometry and Symbolism:</li>
        <li>Translation, Interpreters:</li>
        <li>Theosis:</li>
      </ul>
