...
class Books extends React.Component {
  render () {
    const Items =  [
      ...
      {author: 'Milton, John', book: 'Paradise Lost',  slug: 'paradise'},
      {author: 'Shelley, Mary', book: 'Frankenstein',  slug: 'frank'},
      {author: '******', book: '******',  slug: 'divider'},
    ...
    const BooksToRead = [
      {author: 'Abbott, Edwin', book: 'Flatland',  slug: 'flat1'},
      {author: 'Dostoyevsky, Fyodor', book: 'Crime and Punishment',  slug: 'crime'},
      {author: 'Dostoyevsky, Fyodor', book: 'The Possessed',  slug: 'possessed'},
      {author: 'Lewis, Matthew Gregory', book: 'The Monk',  slug: 'monk1'},
      {author: 'Melville, Herman', book: 'Moby Dick',  slug: 'moby'},
      {author: 'Norris, Frank', book: 'McTeague',  slug: 'teague'},
      {author: 'Solzhenitsyn, Aleksandr ', book: 'The Gulag Archipelago: An Experiment in Literary Investigation',  slug: 'gulag'},
      {author: 'Wells, H. G.', book: 'Island of Dr. Moreau',  slug: 'island'},
      {author: '', book: '',  slug: ''},
      ]
