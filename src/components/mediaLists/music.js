...
class Music extends React.Component {
  render () {
    return (
      ...
      <li>Animals:</li>
        <div className='twoColumn'>
        <a href='https://www.youtube.com/watch?v=uS90B4sZf7U'
      ...
      <li>Cranberries</li>
        <div className='twoColumn'>
          <a href='https://www.youtube.com/watch?v=Zz-DJr1Qs54'
          >Ode to my Family</a><br/>
          <a href='https://www.youtube.com/watch?v=Yam5uK6e-bQ'
          >Dreams</a><br/>
        </div>
        <hr/>
      ...
      <li>Dido</li>
        <div className='twoColumn'>
          <a href='https://www.youtube.com/watch?v=1TO48Cnl66w'
          >Thank You</a><br/>
          <a href='https://www.youtube.com/watch?v=9LtrXAgsvB0'
      ...
      <li>Duran Duran</li>
        <div className='twoColumn'>
          <a href='https://www.youtube.com/watch?v=wUgLge_MPIM'
          >Ordinary World</a><br/>
          <a href='https://www.youtube.com/watch?v=Epj84QVw2rc'
          >Come Undone</a><br/>
        </div>
        <hr/>
      <li>Eddie Brickell:</li>
        <a href='https://www.youtube.com/watch?v=tDl3bdE3YQA'
        >What I am</a><br/>
        <hr/>
      <li>Edward Maya</li>
      <li>Enigma</li>
        <div className='twoColumn'>
          <a href='https://www.youtube.com/watch?v=Rk_sAHh9s08'
          >Return to Innocense</a><br/>
          <a href='https://www.youtube.com/watch?v=f8mMWh62XpU'
