    ...
    return (
      ...
      <table>
        <tr>
          ...
          <td>
            <input type='number' value = {this.state.SunHours}
            onChange={this.changeSunHours}/>
          </td>
        </tr>
        <tr>
          <th>
          ...
          <td>
            <input type='number' value = {this.state.CloudyDays}
            onChange={this.changeCloudyDays}/>
          </td>
        </tr>
        <tr>
          <th>
          ...
          <td>
            <input type='number' value = {this.state.LentgthOfWire}
            onChange={this.changeLentgthOfWire}/>
          </td>
        </tr>
      </table>
      <br /><br />
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            ...
            onChange={this.changeLightNumber}/>
          </td>
          <td>
            <input type='number' value = {this.state.LightPower}
            onChange={this.changeLightPower}/>
          </td>
          <td>
            <input type='number' value = {this.state.LightHrs}
            onChange={this.changeLightHrs}/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            ...
            onChange={this.changePumpNumber}/>
          </td>
          <td>
            <input type='number' value = {this.state.PumpPower}
            onChange={this.changePumpPower}/>
          </td>
          <td>
            <input type='number' value = {this.state.PumpHrs}
            onChange={this.changePumpHrs}/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            ...
            onChange={this.changeControlNumber}/>
          </td>
          <td>
            <input type='number' value = {this.state.ControlPower}
            onChange={this.changeControlPower}/>
          </td>
          <td>
            <input type='number' value = {this.state.ControlHrs}
            onChange={this.changeControlHrs}/>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            ...
            onChange={this.changeFanNumber}/>
          </td>
          <td>
            <input type='number' value = {this.state.FanPower}
            onChange={this.changeFanPower}/>
          </td>
          <td>
            <input type='number' value = {this.state.FanHrs}
            onChange={this.changeFanHrs}/>
          </td>
        </tr>
      </table>
      <br /><br />
